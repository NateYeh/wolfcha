...
export function GameSetupModal({
  ...
  const roleDescriptions = useMemo<Record<Role, string>>(
    () => ({
      ...
      Knight: t("gameSetup.rolePreference.desc.knight"),
      MuteElder: t("gameSetup.rolePreference.desc.muteElder"),
      Dreamweaver: t("gameSetup.rolePreference.desc.dreamweaver"),
      WolfBeauty: t("gameSetup.rolePreference.desc.wolfBeauty"),
      WolfKing: t("gameSetup.rolePreference.desc.wolfKing"),
