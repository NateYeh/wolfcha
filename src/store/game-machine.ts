...
export const VALID_TRANSITIONS: Record<Phase, Phase[]> = {
  ...
  // 夜晚流程：守衛 → 禁言長老 → 攝夢人 → 魔術師 → 狼美人魅惑 → 狼人 → 女巫 → 預言家 → 結算。
  // 每個鍵列出「允許的下一步」，同時涵蓋角色缺席時的整步略過。
  NIGHT_START: ["NIGHT_GUARD_ACTION", "NIGHT_MUTE_ACTION", "NIGHT_DREAM_ACTION", "NIGHT_MAGICIAN_ACTION", "NIGHT_WOLF_BEAUTY_ACTION", "NIGHT_WOLF_ACTION"],
  NIGHT_GUARD_ACTION: ["NIGHT_MUTE_ACTION", "NIGHT_DREAM_ACTION", "NIGHT_MAGICIAN_ACTION", "NIGHT_WOLF_BEAUTY_ACTION", "NIGHT_WOLF_ACTION"],
  NIGHT_MUTE_ACTION: ["NIGHT_DREAM_ACTION", "NIGHT_MAGICIAN_ACTION", "NIGHT_WOLF_BEAUTY_ACTION", "NIGHT_WOLF_ACTION"],
  NIGHT_DREAM_ACTION: ["NIGHT_MAGICIAN_ACTION", "NIGHT_WOLF_BEAUTY_ACTION", "NIGHT_WOLF_ACTION"],
  NIGHT_MAGICIAN_ACTION: ["NIGHT_WOLF_BEAUTY_ACTION", "NIGHT_WOLF_ACTION"],
  // 狼美人先魅惑、狼隊再刀；沒有狼美人的盤直接進狼刀，沒有狼的盤再略過到女巫
  NIGHT_WOLF_BEAUTY_ACTION: ["NIGHT_WOLF_ACTION", "NIGHT_WITCH_ACTION"],
