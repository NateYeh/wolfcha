...
export const getSystemMessages = (locale?: AppLocale) => {
  ...
  return {
    ...
    muteActionStart: t("system.muteActionStart"),
    dreamActionStart: t("system.dreamActionStart"),
    magicianActionStart: t("system.magicianActionStart"),
    wolfBeautyActionStart: t("system.wolfBeautyActionStart"),
    ...
    charmRevenge: (seat: number, name: string) => t("system.charmRevenge", { seat, name }),
...
export const getUiText = (locale?: AppLocale) => {
  ...
  return {
    ...
    waitingMute: t("ui.waitingMute"),
    muteActing: t("ui.muteActing"),
    waitingDream: t("ui.waitingDream"),
    dreamActing: t("ui.dreamActing"),
    waitingMagician: t("ui.waitingMagician"),
    magicianActing: t("ui.magicianActing"),
    wolfBeautyActing: t("ui.wolfBeautyActing"),
    waitingWolfBeauty: t("ui.waitingWolfBeauty"),
